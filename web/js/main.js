! function() {
    ...
    function s(i) {
        ...
        function n(e = {}, t = {}) {
            ...
            var s, i, n, r;
            const a = null === (s = document) || void 0 === s ? void 0 : s.querySelector("[data-burger]"),
                ...
                d = null === (r = document) || void 0 === r ? void 0 : r.querySelector("[data-menu-overlay]");
            null == a || a.addEventListener("click", (s => {
                null == a || a.classList.toggle("burger--active"), null == l || l.classList.toggle("menu--active"), null != l && l.classList.contains("menu--active") ? (null == a || a.setAttribute("aria-expanded", "true"), null == a || a.setAttribute("aria-label", "Закрыть меню"), (() => {
                    var t;
                    const s = null === (t = document) || void 0 === t ? void 0 : t.querySelectorAll(".fixed-block"),
                        i = window.scrollY,
                ...
                })()) : (null == a || a.setAttribute("aria-expanded", "false"), null == a || a.setAttribute("aria-label", "Открыть меню"), t())
            })), null == d || d.addEventListener("click", (() => {
                null == a || a.setAttribute("aria-expanded", "false"), null == a || a.setAttribute("aria-label", "Открыть меню"), a.classList.remove("burger--active"), l.classList.remove("menu--active"), t()
            })), null == o || o.forEach((e => {
            ...
            for (let i = 1; i < arguments.length; i += 1) {
                ...
                if (null != n && (s = n, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                    ...
                    for (let t = 0, i = s.length; t < i; t += 1) {
                        ...
                        void 0 !== r && r.enumerable && (w(e[i]) && w(n[i]) ? n[i].__swiper__ ? e[i] = n[i] : C(e[i], n[i]) : !w(e[i]) && w(n[i]) ? (e[i] = {}, n[i].__swiper__ ? e[i] = n[i] : C(e[i], n[i])) : e[i] = n[i])
                    }
                }
            }
            var s;
                ...
                updateSlides: function() {
                    ...
                    for (let n = 0; n < p; n += 1) {
                        ...
                        if (y && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display")) {
                            ...
                            c[n] && (c[n].swiperSlideSize = x), f.push(x), i.centeredSlides ? (C = C + x / 2 + E / 2 + w, 0 === E && 0 !== n && (C = C - r / 2 - w), 0 === n && (C = C - r / 2 - w), Math.abs(C) < .001 && (C = 0), i.roundLengths && (C = Math.floor(C)), S % i.slidesPerGroup == 0 && u.push(C), h.push(C)) : (i.roundLengths && (C = Math.floor(C)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(C), h.push(C), C = C + x + w), e.virtualSize += x + w, E = x, S += 1
                        }
                    }
        ...
        var P = {
                slideTo: function(e, t, s, i, n) {
                    ...
                    let b;
                    if (b = a > p ? "next" : a < p ? "prev" : "reset", u && -g === r.translate || !u && g === r.translate) return r.updateActiveIndex(a), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== l.effect && r.setTranslate(g), "reset" !== b && (r.transitionStart(s, b), r.transitionEnd(s, b)), !1;
                    if (l.cssMode) {
                ...
                slideToClickedSlide: function() {
                    ...
                    if (t.loop) {
                        ...
                        n = parseInt(v(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), g((() => {
                            e.slideTo(r)
            ...
            O = {
                loopCreate: function() {
                    ...
                    for (let e = 0; e < o.length; e += 1) n.append(v(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
                    for (let e = l.length - 1; e >= 0; e -= 1) n.prepend(v(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass))
                },
                loopFix: function() {
                    const e = this;
        ...
        function A(e) {
            ...
            if (Object.assign(n, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = f, l.startY = m, n.touchStartTime = b(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== c.type) {
                let e = !0;
        ...
        var j = {
            attachEvents: function() {
                ...
                e.onTouchStart = A.bind(e), e.onTouchMove = z.bind(e), e.onTouchEnd = I.bind(e), s.cssMode && (e.onScroll = N.bind(e)), e.onClick = G.bind(e), i.touch && !B && (t.addEventListener("touchstart", _), B = !0), H(e, "on")
            },
        ...
        const R = {
                ...
                images: {
                    loadImage: function(e, t, s, i, n, r) {
                        ...
                        v(e).parent("picture")[0] || e.complete && n ? d() : t ? (l = new a.Image, l.onload = d, l.onerror = d, i && (l.sizes = i), s && (l.srcset = s), t && (l.src = t)) : d()
                    },
        ...
        class X {
            constructor() {
                ...
                if (1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = C({}, t), e && !t.el && (t.el = e), t.el && v(t.el).length > 1) {
                    const e = [];
                ...
                const r = this;
                var a;
                r.__swiper__ = !0, r.support = M(), r.device = (void 0 === (a = {
                ...
                const d = C({}, W, l);
                return r.params = C({}, d, Y, t), r.originalParams = C({}, r.params), r.passedParams = C({}, t), r.params && r.params.on && Object.keys(r.params.on).forEach((e => {
        ...
        Object.keys(R).forEach((e => {
            ...
            s("init", (() => {
                ...
                })), r.observe(t.el)) : (n.addEventListener("resize", a), n.addEventListener("orientationchange", l))
            })), s("destroy", (() => {
                r && r.unobserve && t.el && (r.unobserve(t.el), r = null), n.removeEventListener("resize", a), n.removeEventListener("orientationchange", l)
            }))
        }, function(e) {
            let {
                swiper: t,
        ...
        U.use([function(e) {
            ...
            function c() {
                ...
                if ("fraction" === s.type && (r.find(J(s.currentClass)).text(s.formatFractionCurrent(c + 1)), r.find(J(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
                    let e;
                    e = s.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                    const i = (c + 1) / p;
                    let n = 1,
                        a = 1;
                    "horizontal" === e ? n = i : a = i, r.find(J(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(t.params.speed)
                }
            ...
            function h() {
                ...
                s.removeClass(e.hiddenClass), s.removeClass(e.modifierClass + e.type), s.removeClass(e.modifierClass + t.params.direction), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && s.off("click", J(e.bulletClass))
            }
            i("init", (() => {
                u(), p(), c()
            })), i("activeIndexChange", (() => {
        ...
        const Q = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--gap"));
        console.log(Q), new U(document.querySelector(".news-slider"), {
            slidesPerView: 1,
            loop: !0,
            spaceBetween: Q,
            navigation: {
