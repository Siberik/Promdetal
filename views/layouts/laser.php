...
<header class="header">
			...
			<div class="container">
			<div class="header__top"><a href="index.php" class="logo header__logo"><img src="images/logo.png" alt="Логотип" width="138" height="38"></a>
				...
				<div class="header__bottom" data-menu="">
					<nav class="nav" title="Главная навигация">
						<ul class="list-reset nav__list">
							...
							<li class="nav__item"><a href="company.php" class="nav__link">О предприятии</a></li>
					...
					</nav><button class="btn-reset header__btn"><svg><use xlink:href="images/sprite.svg#phone"></use></svg> Перезвоните мне</button>
...
<footer class="footer">
			<div class="container grid">
				<div class="footer__col"><a href="#" class="logo footer__logo"><img src="images/logo.png" alt="Логотип" width="180" height="38"></a></div>
